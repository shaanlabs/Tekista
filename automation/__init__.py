...
class TaskAutomationEngine:
    ...
    def on_task_completed(task_id, actual_hours=None):
        ...
        try:
            ...
            if user_profile and actual_hours:
                new_workload = max(0, user_profile.current_workload_hours - actual_hours)
    ...
    def on_task_status_changed(task_id, old_status, new_status):
        ...
        try:
            ...
            return {"success": True, "message": f"Status changed from {old_status} to {new_status}"}
    ...
    def on_task_created(task_id):
        ...
        try:
            ...
            job = find_and_assign_tasks_for_available_users.delay(task.project.organization_id)
...
class PerformanceCalculator:
    ...
    def calculate_performance_score(user_id):
        ...
        try:
            ...
            workload_balance = 1.0 - (
                ...
                if profile.max_weekly_hours > 0 else 0
            )
            ...
            performance_score = (
                completion_rate * 0.35 +  # 35% completion rate
                estimation_accuracy * 0.25 +  # 25% estimation accuracy
                workload_balance * 0.20 +  # 20% workload balance
                skill_utilization * 0.20  # 20% skill utilization
            ) * 100
    ...
    def calculate_team_performance(organization_id):
        ...
        try:
            ...
            team_performance.sort(key=lambda x: x.get("performance_score", 0), reverse=True)
