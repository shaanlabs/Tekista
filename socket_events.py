...
def init_socketio(app):
    ...
    def handle_connect():
        ...
        if current_user.is_authenticated:
            ...
            emit("connected", {"user_id": user_id, "unread_count": unread_count})
    ...
    def handle_mark_read(data):
        ...
        if success:
            ...
            emit(
                ...
                {"notification_id": notification_id, "unread_count": unread_count},
            )
    ...
    def handle_mark_all_read():
        ...
        emit(
            "all_notifications_marked_read", {"marked_count": count, "unread_count": 0}
        )
    ...
    def handle_unread_count_request():
        ...
        emit("unread_count_update", {"unread_count": unread_count})
...
def emit_task_assigned(
    ...
    notification = NotificationEvents.task_assigned(
        user_id, task_id, task_title, assigned_by_id
    )
...
def emit_task_completed(
    ...
    notification = NotificationEvents.task_completed(
        user_id, task_id, task_title, completed_by_id
    )
...
def emit_performance_update(user_id: int, new_score: float, old_score: float):
    ...
    notification = NotificationEvents.performance_update(user_id, new_score, old_score)
