...
class TaskWorkflow:
    ...
    def auto_assign_task(task_id: int) -> Dict:
        ...
        try:
            ...
            if not best_user_id:
                ...
                return {
                    'success': False,
                    'message': 'No suitable user available'
                }
    ...
    def complete_task(
        ...
        try:
            ...
            perf_log = PerformanceLog.query.filter_by(
                user_id=user_id
...
class DashboardDataProvider:
    ...
    def get_user_dashboard_data(user_id: int) -> Dict:
        ...
        try:
            ...
            # Active tasks
            active_tasks = db.session.query(TaskAssignment).filter_by(
                assigned_user_id=user_id,
                assignment_status='assigned'
            ).all()
            ...
            # AI Suggested tasks
            suggestions = RecommendationEngine.recommend_tasks_for_user(user_id, top_n=3)
