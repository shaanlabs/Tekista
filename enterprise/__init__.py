...
ROLE_PERMISSIONS = {
    ...
    Role.PROJECT_MANAGER: [
        ...
        Permission.DELETE_TASKS, Permission.ASSIGN_TASKS,
        Permission.VIEW_PROJECTS, Permission.CREATE_PROJECTS, Permission.EDIT_PROJECTS,
        Permission.MANAGE_PROJECT_MEMBERS, Permission.VIEW_TEAM,
        Permission.VIEW_AUDIT_LOG
    ],
    Role.TEAM_MEMBER: [
        Permission.VIEW_TASKS, Permission.CREATE_TASKS, Permission.EDIT_TASKS,
        Permission.VIEW_PROJECTS, Permission.VIEW_TEAM
    ],
    Role.VIEWER: [
        Permission.VIEW_TASKS, Permission.VIEW_PROJECTS, Permission.VIEW_TEAM
    ]
}
    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            ...
            if current_user.role not in roles:
                logger.warning(f"Role denied for user {current_user.id}: required {roles}")
        ...
        def decorated_function(*args, **kwargs):
            ...
            if current_user.is_authenticated:
                ...
                audit = AuditLog(
                    ...
                    resource_id=kwargs.get('id') or kwargs.get('task_id') or kwargs.get('project_id'),
