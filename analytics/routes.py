...
def get_task_distribution():
    ...
    chart_data = [
        {"skill": skill, "count": count} for skill, count in distribution.items()
    ]
...
def get_top_performers():
    ...
    performers = AnalyticsEngine.get_top_performers(current_user.organization_id, limit)
...
def get_performance_trend():
    ...
    trend = AnalyticsEngine.get_team_performance_trend(
        current_user.organization_id, days, interval
    )
...
def get_projects():
    ...
    projects = AnalyticsEngine.get_project_statistics(current_user.organization_id)
        ...
        jsonify(
            {
                ...
                "kpis": {
                    ...
                    "team_performance_score": team_perf.get(
                    ...
                    "avg_performance_score": productivity.get(
...
def export_analytics():
    ...
    return (
        jsonify({"export_date": analytics.get("generated_at"), "data": analytics}),
        200,
    )
