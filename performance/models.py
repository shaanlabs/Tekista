...
class PerformanceLog(db.Model):
    ...
    def __repr__(self):
        return (
            f"<PerformanceLog user={self.user_id} score={self.performance_score:.1f}>"
        )
...
class PerformanceBadge(db.Model):
    ...
    __table_args__ = (Index("idx_performance_badge_user_id", "user_id"),)
