        ...
        jsonify(
            {
                ...
                "user_2": summary_2,
                "difference": {
                    "score_difference": summary_1["current_performance_score"]
                    - summary_2["current_performance_score"],
                    "winner": (
                        "user_1"
                        if summary_1["current_performance_score"]
                        > summary_2["current_performance_score"]
                        else "user_2"
                    ),
                },
...
def get_team_performance_trends():
    ...
    for user in users:
        ...
        if "error" not in trends:
            all_trends.append(
                {"user_id": user.id, "username": user.username, "trends": trends}
            )
...
def get_performance_snapshots(user_id):
    ...
    snapshots = (
        PerformanceSnapshot.query.filter(
